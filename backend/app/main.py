...
from app.api import auth, health, members, parent, points, rewards, setup, tasks, today
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    for module in (health, setup, auth, parent, members, tasks, today, points, rewards):
